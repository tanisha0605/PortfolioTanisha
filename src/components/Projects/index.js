    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'java app' ?
            <ToggleButton active value="java app" onClick={() => setToggle('java app')}>JAVA APPS</ToggleButton>
            :
            <ToggleButton value="java app" onClick={() => setToggle('java app')}>JAVA APPS</ToggleButton>
          }
